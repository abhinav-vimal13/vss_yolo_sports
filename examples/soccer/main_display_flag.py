...
PLAYER_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'data/football-player-detection-fp16.engine')
PITCH_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'data/football-pitch-detection-fp16.engine')
BALL_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'data/football-ball-detection-fp16.engine')
...
def run_pitch_detection(source_video_path: str, device: str) -> Iterator[np.ndarray]:
    pitch_detection_model = YOLO(PITCH_DETECTION_MODEL_PATH, task='pose')#.to(device=device)
...
def main(source_video_path: str, target_video_path: str, device: str, mode: Mode, show_display: bool) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--show_display', action='store_true', help='Show video frames during processing')
